...
|--------|-----------|------------------|
| **Data Layer** | DataLoader · Normalizer · Splitter | Parsing de arquivos, normalização, particionamento |
| **Engine Layer** | DEEngine · Islands · Migration | Otimização por Evolução Diferencial |
| **Agent Layer** | Snapshot · History · Tuning | Monitoramento em tempo real e controle de parâmetros |
| **UI Layer** | Screens · Charts · State | Interação e visualização |
| **Core Layer** | Matrix (Float64List) · QR · Types · PRNG | Fundamentos matemáticos |

**Fluxo de dados:** Data Layer → Engine Layer → Agent Layer → UI Layer
